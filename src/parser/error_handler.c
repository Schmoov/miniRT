...
void	exit_with_error(t_parsing_error err, const char *filename, int num_line)
{
	...
	ERR_MSG_AMBIENT_RATIO,
	ERR_MSG_AMBIENT_COLOR,
	ERR_MSG_AMBIENT_DUPLICATE,
	ERR_MSG_CAMERA_POSITION,
	ERR_MSG_CAMERA_ORIENTATION,
	ERR_MSG_CAMERA_FOV,
	ERR_MSG_CAMERA_DUPLICATE,
	ERR_MSG_CYLINDER_POSITION,
	ERR_MSG_CYLINDER_AXIS,
	ERR_MSG_CYLINDER_DIAMETER,
	ERR_MSG_CYLINDER_HEIGHT,
	ERR_MSG_CYLINDER_COLOR,
	ERR_MSG_LIGHT_POSITION,
	ERR_MSG_LIGHT_BRIGHTNESS,
	ERR_MSG_LIGHT_COLOR,
	ERR_MSG_SPHERE_POSITION,
	ERR_MSG_SPHERE_DIAMETER,
	ERR_MSG_SPHERE_COLOR,
	ERR_MSG_PLANE_POSITION,
	ERR_MSG_PLANE_AXIS,
	ERR_MSG_PLANE_COLOR,
	ERR_MSG_CONE_POSITION,
	ERR_MSG_CONE_AXIS,
	ERR_MSG_CONE_HEIGHT,
	ERR_MSG_CONE_COLOR,
	ERR_MSG_CONE_ANGLE,
	ERR_MSG_UNKNOWN_ELEMENT,
	ERR_MSG_NO_AMBIENT_LIGHTING,
	ERR_MSG_NO_CAMERA,
	ERR_MSG_NO_LIGHT,
	ERR_MSG_NO_OBJECTS,
